...
set_pg_strategy S_HM_ring_risc -macros simpleuart -pattern { {pattern: P_HM_ring} {nets: {VDD VSS}} {offset: {1 1}} }
...
set_pg_strategy S_HM_ring_risc2 -macros spimemio -pattern { {pattern: P_HM_ring2} {nets: {VDDh VSS}} {offset: {1 1}} }
...
set_pg_strategy core_ring \
   ...
   -extension {{{side:1} {nets:VDD VSS VDDh} {direction: B} {stop:design_boundary_and_generate_pin}}}
...
create_pg_mesh_pattern P_top_two \
	-layers { \
		{ {horizontal_layer: M9} {width: 1.0} {spacing: interleaving} {pitch: 30} {offset: 1} {trim : true} } \
		{ {vertical_layer: M8}   {width: 0.95} {spacing: interleaving} {pitch: 30} {offset: 1} {trim : true} } \
		} \
	-via_rule { {intersection: adjacent} {via_master : default} }

set_pg_strategy router_top \
	-voltage_areas DEFAULT_VA \
	-pattern   { {name: P_top_two} {nets:{VDDh VDD VSS}} {offset:1} } \
	-extension { {nets: VDDh VSS VDD VSS} {direction: T B L R}{stop:pad_ring} } \
          -blockage {{nets: VDD VDDh VSS} {blocks: {spimemio simpleuart}}}
...
create_pg_mesh_pattern M2_mesh \
	-layers {{{vertical_layer: M2} {width: 0.09}  {track_alignment: track} {spacing: interleaving}{pitch:5} {trim:true}}\
                   {{horizontal_layer: M3} {width: 0.09} {spacing: interleaving} {track_alignment: track}{pitch:20} {trim:true}}}\
	-via_rule { {intersection: adjacent} {via_master : default} }

set_pg_strategy router_low_mesh\
	-core \
	-pattern {{name:M2_mesh}{nets:VDDh VSS VDD VSS} {offset:0.5}}\
           -blockage {{nets: VDD VSS VDDh} {blocks:{simpleuart spimemio}}}
...
set_pg_strategy M1_vddl_rail \
	...
	-pattern {{pattern: P_std_cell_rail}{nets: VDD VSS}} \
          -blockage {{nets:VDDh VDD VSS} {blocks: {spimemio simpleuart}}}
