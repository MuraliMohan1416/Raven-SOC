...
set corner1 				"ff_m125c"; # name of corner1	
set corner_constraints($corner1)        "../design_data/raven_c_ff_m125c.tcl" ;# for corner1 specific SDC constraints 

set corner2 				"ss_m40c"; # name of corner2	
set corner_constraints($corner2)        "../design_data/raven_c_ss_m40c.tcl" ; # for corner2 specific SDC constraints 
